...
def example_roi_selection():
    ...
    print("   python run_experiments.py --experiments sgfa_parameter_comparison \\")
    print("       --select-rois volume_sn_voxels.tsv")
    print("   → Result directory: sgfa_parameter_comparison_rois-sn_run_TIMESTAMP/")
...
def example_combined_options():
    ...
    print("\n📁 Result directory:")
    print("   sgfa_parameter_comparison_rois-sn+putamen_excl-age+sex+tiv_K-2+3_run_TIMESTAMP/")
