...
class TestUtilityIntegration:
    ...
    def test_pickle_roundtrip_with_numpy(self, temp_dir):
        ...
        # Verify arrays
        np.testing.assert_array_equal(loaded_data['arrays']['Z'], original_data['arrays']['Z'])
        np.testing.assert_array_equal(loaded_data['arrays']['W'], original_data['arrays']['W'])
        np.testing.assert_array_equal(loaded_data['arrays']['sigma'], original_data['arrays']['sigma'])
    ...
    def test_memory_monitoring_during_operation(self, mock_psutil):
        ...
        memory_values = [100 * 1024**2, 150 * 1024**2, 120 * 1024**2]  # 100MB -> 150MB -> 120MB
