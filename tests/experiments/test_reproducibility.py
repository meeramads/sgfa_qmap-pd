...
class TestReproducibility:
    ...
    def test_error_handling_invalid_scenarios(self, mock_config):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            mock_config['reproducibility']['test_scenarios'] = [
    ...
    @pytest.mark.parametrize("scenario", ['identical_seeds', 'different_hardware', 'version_stability'])
    ...
    def test_reproducibility_report_generation(self, mock_config):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            report_files = list(Path(tmpdir).rglob("*report*")) + list(Path(tmpdir).rglob("*summary*"))
