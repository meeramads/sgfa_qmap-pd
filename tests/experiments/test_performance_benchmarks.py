...
class TestPerformanceBenchmarks:
    ...
    def synthetic_data(self):
        ...
        return generate_synthetic_data(
            num_sources=2,
            K=3,
            num_subjects=15,  # Very small for fast testing
            seed=42
        )
    ...
    def test_scalability_benchmarks(self, mock_config):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            mock_config['performance_benchmarks']['benchmark_configs'] = {
                'scale_1': {
                    'n_subjects': 10,
                    'n_features_per_view': [15, 20]
                },
                'scale_2': {
                    'n_subjects': 20,
                    'n_features_per_view': [25, 30]
                }
            }
    ...
    def test_multiple_benchmark_configs(self, mock_config):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            mock_config['performance_benchmarks']['benchmark_configs'] = {
                'config_1': {
                    'n_subjects': 12,
                    'n_features_per_view': [20, 15]
                },
                'config_2': {
                    'n_subjects': 18,
                    'n_features_per_view': [25, 20]
                },
                'config_3': {
                    'n_subjects': 24,
                    'n_features_per_view': [30, 25]
                }
            }
    ...
    def test_gpu_benchmarks(self, mock_config):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Add GPU tracking
            mock_config['performance_benchmarks']['metrics_to_track'].append('gpu_utilization')
    ...
    @pytest.mark.parametrize("metric", ['training_time', 'memory_usage', 'convergence_rate'])
