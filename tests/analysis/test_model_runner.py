...
class TestModelRunner:
    ...
    def test_run_standard_analysis_single_run(self, sample_config, sample_synthetic_data, sample_hyperparameters):
    ...
    def test_run_standard_analysis_multiple_runs(self, sample_config, sample_synthetic_data, sample_hyperparameters):
    ...
    def test_run_standard_analysis_with_failure(self, mock_logger, sample_config, sample_synthetic_data, sample_hyperparameters):
    ...
    def test_run_single_mcmc_mock(self, sample_config, sample_synthetic_data, sample_hyperparameters, mock_mcmc_results):
        ...
        with patch('analysis.model_runner.MCMC', return_value=mock_mcmc), \
             patch('analysis.model_runner.NUTS'), \
    ...
    def test_extract_robust_parameters_missing_data(self, sample_config):
        ...
        incomplete_results = {'Z': np.random.normal(0, 1, (100, 50, 3))}  # Missing W, sigma
    ...
    def test_extract_robust_parameters_invalid_shapes(self, sample_config):
        ...
        invalid_results = {
            'Z': np.random.normal(0, 1, (10, 5)),  # Wrong shape (missing factor dimension)
            'W': np.random.normal(0, 1, (100, 45, 3)),
...
class TestModelRunnerIntegration:
    ...
    def test_full_analysis_pipeline(self, sample_config, sample_synthetic_data, sample_hyperparameters):
