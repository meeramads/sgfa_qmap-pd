...
class TestGetDataInterface:
    ...
    def test_get_qmap_data_with_kwargs(self, mock_qmap_pd):
        ...
        get_data('qmap_pd', data_dir='/fake/dir', 
                clinical_rel='clinical.csv', volumes_rel='volumes.csv')
    ...
    def test_case_insensitive_dataset_names(self):
        ...
        with patch('get_data.generate_synthetic_data') as mock_synth, \
             patch('get_data.qmap_pd') as mock_qmap:
